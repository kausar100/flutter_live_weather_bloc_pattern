...
import 'package:open_meteo_api/models/models.dart';
...
class OpenMeteoApiClient {
  ...
  Future<LocationOMA> locationSearch(String query) async {
    ...
    return LocationOMA.fromJson(results.first as Map<String, dynamic>);
  }

  /// Fetches [Weather] for a given [latitude] and [longitude].
  Future<WeatherOMA> getWeather({
    ...
    return WeatherOMA.fromJson(weatherJson);
  }
}
